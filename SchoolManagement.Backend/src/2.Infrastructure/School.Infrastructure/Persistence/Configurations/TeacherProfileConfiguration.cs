...
public class TeacherProfileConfiguration : IEntityTypeConfiguration<TeacherProfile>
{
    public void Configure(EntityTypeBuilder<TeacherProfile> builder)
    {
        ...
        builder.Property(p => p.AlternateMobile).HasMaxLength(20);
        builder.Property(p => p.Gender).HasMaxLength(10).IsRequired();
        builder.Property(p => p.Qualification).HasMaxLength(200).IsRequired();
        builder.Property(p => p.Specialization).HasMaxLength(200);
        builder.Property(p => p.Address).HasMaxLength(500);
        builder.Property(p => p.City).HasMaxLength(100);
        builder.Property(p => p.State).HasMaxLength(100);
        builder.Property(p => p.EmployeeId).HasMaxLength(20).IsRequired();
        builder.HasOne(p => p.User).WithOne(u => u.TeacherProfile)
