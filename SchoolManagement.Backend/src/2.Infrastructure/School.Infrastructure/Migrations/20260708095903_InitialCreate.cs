...
namespace School.Infrastructure.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "TeacherClassRoomAssignments",
                columns: table => new
                {
                    TeacherProfileId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ClassRoomId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AssignmentDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "SYSDATETIMEOFFSET()")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeacherClassRoomAssignments", x => new { x.TeacherProfileId, x.ClassRoomId });
                    table.ForeignKey(
                        name: "FK_TeacherClassRoomAssignments_ClassRooms_ClassRoomId",
                        column: x => x.ClassRoomId,
                        principalTable: "ClassRooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TeacherClassRoomAssignments_TeacherProfiles_TeacherProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AttendanceRecords_ApplicationUsers_RecordedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DailyActivityLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DailyActivityLogs_StudentProfiles_StudentId",
                        column: x => x.StudentId,
                        principalTable: "StudentProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DailyActivityLogs_TeacherProfiles_TeacherId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DailyActivityLogs_StudentId_LogTimestamp",
                table: "DailyActivityLogs",
                columns: new[] { "StudentId", "LogTimestamp" });

            migrationBuilder.CreateIndex(
                name: "IX_DailyActivityLogs_TeacherId",
                table: "DailyActivityLogs",
                column: "TeacherId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeacherClassRoomAssignments_ClassRoomId",
                table: "TeacherClassRoomAssignments",
                column: "ClassRoomId");
